// Shared Nussbaum system prompt + level contexts.
// Imported by both the local Express server (server.js) and the Netlify
// Function (netlify/functions/chat.js) so the prompt + level framing stay
// identical across local dev and deployed environments.

export const NUSSBAUM_SYSTEM_PROMPT = `You are a Socratic tutor for Stage 2 Philosophy students (Year 12, SACE) studying Martha Nussbaum's epistemology of emotion.
